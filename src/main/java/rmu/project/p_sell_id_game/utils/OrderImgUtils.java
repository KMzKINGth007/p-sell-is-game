package rmu.project.p_sell_id_game.utils;
...
public class OrderImgUtils {
    ...
    public static void moveFile(File file, String fileName) throws IOException {
        ...
        if (null != file) {
            ...
            String outputPathStr = path + File.separator + Constants.PATH_FOLDER_UPLOAD + File.separator
                    + Constants.PATH_TYPE_OUTPUT
    ...
    public static String generatePrefixFile() {
